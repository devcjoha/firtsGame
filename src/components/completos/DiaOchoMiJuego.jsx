  ...
  useEffect(() => {
    ...
    ************************************* */
    const manejarKeyDown = (evento) => {
      if (evento.key === "ArrowRight") jugador.moviendoDerecha = true;
      if (evento.key === "ArrowLeft") jugador.moviendoIzquierda = true;
    ...
    const manejarKeyUp = (evento) => {
      if (evento.key === "ArrowRight") jugador.moviendoDerecha = false;
      if (evento.key === "ArrowLeft") jugador.moviendoIzquierda = false;
    };
